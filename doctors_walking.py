...
for id, pop in worst_pop_points.iterrows():
    ...
    to_node = osm.distance.nearest_nodes(walking_graph, nearest_doctors.x, nearest_doctors.y)
...
worst_pop_points["doctors_walking_astar"] = travel_time_list
...
results = worst_pop_points[["OA21CD", "doctors_walking_astar"]]
...
gm_oas_plot.plot(
    ...
    legend_kwds = {
    'loc': 'lower right',
    'title': 'Shortest Walking Time to Nearest Doctors (mins)',
    'frameon': True,
    'borderpad': 0.6,
    'labelspacing': 0.5
    })
...
legend.set_title("Walking Travel Time to Nearest Doctors (minutes)", prop={'size':10})
