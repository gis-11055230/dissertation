...
walking_graph = graph.graph_from_polygon(gm_buffer_geom, network_type = "walk", simplify = True, retain_all = True, truncate_by_edge = True)
...
driving_graph = graph.graph_from_polygon(gm_buffer_geom, network_type = "drive", simplify = True, retain_all = True, truncate_by_edge = True)
